...
if ! ./wp-cli.phar core is-installed --allow-root; then
    ...
    ./wp-cli.phar core install --url=https://${DOMAIN_NAME} --title=${SITE_NAME} --admin_user=${WP_ADMIN} --admin_password=${WP_ADMIN_PASSWORD} --admin_email=${WP_ADMIN_EMAIL} --allow-root
else
